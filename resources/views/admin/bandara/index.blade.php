...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.bandara.create') }}" class="inline-flex items-center px-5 py-2.5 bg-indigo-600 text-white text-sm font-bold rounded-xl hover:bg-indigo-700 transition shadow-lg shadow-indigo-100">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex justify-end items-center gap-3">
                            <a href="{{ route('admin.bandara.edit', $b->id) }}" class="text-gray-400 hover:text-indigo-600 transition">
                                <i class="fas fa-edit"></i>
                            </a>

                            <form action="{{ route('admin.bandara.destroy', $b->id) }}" method="POST" class="inline" onsubmit="return confirm('Hapus bandara ini?')">
                                @csrf 
                                @method('DELETE')
